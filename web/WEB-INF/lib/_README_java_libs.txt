...
Apache POI (Microsoft Documents)

    Use:    Read/write Microsoft documents
    From:   http://poi.apache.org/
    Lic:    Apache 2.0
    Last:   8/28/2016
...
Google Data (GData)
    ...
    Use:    Access to Google Spreadsheets.
    From:   https://developers.google.com/google-apps/spreadsheets/
    Lic:    Apache 2.0
    Last:   10/29/2015, v1.47.1

    NOTE that the gdata.jar file was locally compiled and jar'd from
    source code via the project googleOauth2-server.

        gdata.jar (locally compiled and jar'd)
        guava-11.0.2.jar
        jsr305.jar
        mail.jar
