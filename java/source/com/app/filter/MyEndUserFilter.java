...
public class MyEndUserFilter
    extends MyEndUserFilterBase
{
    //##################################################
    //# sort (enum)
    //##################################################
    ...
    @Override
    protected void applyConditionsTo(MyEndUserCriteria c)
    {
        // none
    }

    @Override
    protected void applySortsTo(MyEndUserCriteria c)
    {
        if ( !usesSort() )
            return;
