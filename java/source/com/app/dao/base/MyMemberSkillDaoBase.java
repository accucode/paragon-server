    ...
    implements MyMemberSkillDaoConstantsIF
{
    ...
    {
        return new MyMemberSkillCriteria(_createCriteria());
    }

    @Override
    public MyMemberSkillCriteria createDetachedCriteria(String alias)
    {
        return new MyMemberSkillCriteria(_createDetachedCriteria(alias));
    }
