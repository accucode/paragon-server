...
public interface MyNoteDaoConstantsIF
{
    //##################################################
    //# fields
    //##################################################
    ...
    String OWNER_TITLE = "ownerTitle";
    String OWNER_TYPE_CODE = "ownerTypeCode";
    String SOURCE_TYPE_CODE = "sourceTypeCode";
    String UID = "uid";
    String UPDATED_UTC_TS = "updatedUtcTs";
    String LOCK_VERSION = "lockVersion";
    String OWNER_TYPE_NAME = "ownerTypeName";
    String SOURCE_TYPE_NAME = "sourceTypeName";
