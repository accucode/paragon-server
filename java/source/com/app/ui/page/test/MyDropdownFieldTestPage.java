...
public final class MyDropdownFieldTestPage
    extends MyPage
{
    //##################################################
    //# singleton
    ...
    private static MyDropdownFieldTestPage _instance;

    public static void installInstance()
    {
        _instance = new MyDropdownFieldTestPage();
    }

    public static MyDropdownFieldTestPage getInstance()
    {
        return _instance;
    }

    private MyDropdownFieldTestPage()
    {
        // singleton
    }
    ...
    private ScDropdownField<Integer> _field;
    ...
    private ScDropdownField<Integer> newListField(String label)
    {
