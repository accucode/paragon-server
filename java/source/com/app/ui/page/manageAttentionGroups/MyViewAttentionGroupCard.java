    ...
    extends MyCard
{
    ...
    private MyModelListener<MyAttentionGroup> newSaveListener()
    {
        return new MyModelListener<MyAttentionGroup>()
        {
            @Override
            protected void handle(MyAttentionGroup e)
            {
                handleSaved(e);
            }
        };
    ...
    public void addSaveListener(MyModelListener<MyAttentionGroup> e)
    {
