 ...
 */
public abstract class MyCrudFrame<P extends MyUidDomainIF, C extends MyUidDomainIF>
    extends ScCardFrame
{
    //##################################################
    //# variables
    ...
    private BiConsumer<C,Boolean> _addSavedListener;
    ...
    public final void onAddSaved(BiConsumer<C,Boolean> e)
    {
        _addSavedListener = e;
    }

    private void fireAddSaved(C e, boolean more)
    {
        if ( _addSavedListener != null )
            _addSavedListener.accept(e, more);
    }
