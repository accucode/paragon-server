...
public abstract class MyVendorBase
    extends MyAbstractDaoDomain<MyVendor>
    ...
    ,MyBasicTimestampsIF
{
    ...
    public static final MyVendorFinder Finder = MyVendorFinder.instance;
    ...
    @Override
    protected final MyVendorValidator getValidator()
    {
        return Validator;
    }

    @Override
    protected final MyVendor asSubclass()
    {
        return (MyVendor)this;
    }
     ...
     */
    public final MyVendor getBasicCopy()
    {
        MyVendor e;
        e = new MyVendor();
     ...
     */
    public final void applyEditableFieldsTo(MyVendor e)
    {
     ...
     * Associations and collections are NOT applied.
     */
    public final void applyEditableFieldsFrom(MyVendor e)
    {
