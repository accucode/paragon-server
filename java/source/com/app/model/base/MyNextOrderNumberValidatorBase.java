...
/**
 * Validation rules for nextOrderNumber.
 */
public class MyNextOrderNumberValidatorBase
    extends MyDomainValidator<MyNextOrderNumber>
{
    //##################################################
    //# static
    //##################################################

    public static final MyNextOrderNumberValidator instance = new MyNextOrderNumberValidator();
    ...
    protected MyNextOrderNumberValidatorBase()
    {
        super();
    ...
    @Override
    public void convertOnly(MyNextOrderNumber value)
    {
        // fields...
    ...
    @Override
    public void validateOnly(MyNextOrderNumber value, KmList<KmErrorIF> errors)
    {
        // fields...
        ...
        if ( !value.hasProject() )
            errors.add(new KmRequiredValidationError("nextOrderNumber", "project"));
    }
