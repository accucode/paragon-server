...
/**
 * Validation rules for customerSite.
 */
public class MyCustomerSiteValidatorBase
    extends MyDomainValidator<MyCustomerSite>
{
    //##################################################
    //# static
    //##################################################

    public static final MyCustomerSiteValidator instance = new MyCustomerSiteValidator();
    ...
    protected MyCustomerSiteValidatorBase()
    {
        super();
    ...
    @Override
    public void convertOnly(MyCustomerSite value)
    {
        // fields...
    ...
    @Override
    public void validateOnly(MyCustomerSite value, KmList<KmErrorIF> errors)
    {
        // fields...
        ...
        if ( !value.hasCustomer() )
            errors.add(new KmRequiredValidationError("customerSite", "customer"));
    }
