...
public abstract class MyHolidayBase
    extends MyAbstractDaoDomain<MyHoliday>
    ...
    ,MyBasicTimestampsIF
{
    ...
    public static final MyMetaHoliday Meta = MyMetaHoliday.instance;
    public static final MyHolidayTools Tools = MyHolidayTools.instance;
    public static final MyHolidayValidator Validator = MyHolidayValidator.instance;
    public static final MyHolidayFinder Finder = MyHolidayFinder.instance;
    ...
    public KmDate getDay()
    {
        return day;
    }

    public void setDay(KmDate e)
    {
        e = Validator.getDayValidator().convert(e);
        day = e;
    }
    ...
    public boolean hasDay(KmDate e)
    {
        return Kmu.isEqual(getDay(), e);
    }
    ...
    @Override
    protected final MyHolidayValidator getValidator()
    {
        return Validator;
    }

    @Override
    protected final MyHoliday asSubclass()
    {
        return (MyHoliday)this;
    }
    ...
    @Override
    public final MyHoliday getCopy()
    {
        return (MyHoliday)super.getCopy();
    }
     ...
     */
    public final MyHoliday getBasicCopy()
    {
        MyHoliday e;
        e = new MyHoliday();
     ...
     */
    public final void applyEditableFieldsTo(MyHoliday e)
    {
     ...
     * Associations and collections are NOT applied.
     */
    public final void applyEditableFieldsFrom(MyHoliday e)
    {
    ...
    {
        if ( !(o instanceof MyHolidayBase) )
            return false;

        MyHolidayBase e = (MyHolidayBase)o;
    ...
    public boolean isSame(MyHoliday e)
    {
        if ( !Kmu.isEqual(getUid(), e.getUid()) ) return false;
        return isSameIgnoringKey(e);
    }

    public boolean isSameIgnoringKey(MyHoliday e)
    {
        if ( !Kmu.isEqual(getAuditLogTitle(), e.getAuditLogTitle()) ) return false;
        if ( !Kmu.isEqual(getCreatedUtcTs(), e.getCreatedUtcTs()) ) return false;
        if ( !Kmu.isEqual(getDay(), e.getDay()) ) return false;
    ...
    public boolean isDifferent(MyHoliday e)
    {
        return !isSame(e);
    }

    public boolean isDifferentIgnoringKey(MyHoliday e)
    {
        return !isSameIgnoringKey(e);
    }
