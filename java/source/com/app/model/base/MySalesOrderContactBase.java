...
public abstract class MySalesOrderContactBase
    ...
    implements MyDomainIF
{
    ...
    public static final MyMetaSalesOrderContact Meta = MyMetaSalesOrderContact.instance;
    public static final MySalesOrderContactTools Tools = MySalesOrderContactTools.instance;
    public static final MySalesOrderContactValidator Validator = MySalesOrderContactValidator.instance;
    ...
    public MySalesOrderContactBase()
    {
        super();
        setUid(newUid());
    ...
    {
        Validator.validate((MySalesOrderContact)this);
    }

    @Override
    public void validateWarn()
    {
        Validator.validateWarn((MySalesOrderContact)this);
    }

    public boolean isValid()
    {
        return Validator.isValid((MySalesOrderContact)this);
    }
    ...
    @Override
    public final MySalesOrderContact getCopy()
    {
        return (MySalesOrderContact)super.getCopy();
    }
    ...
    {
        if ( !(o instanceof MySalesOrderContactBase) )
            return false;

        MySalesOrderContactBase e = (MySalesOrderContactBase)o;
    ...
    public boolean isSame(MySalesOrderContact e)
    {
        if ( !Kmu.isEqual(getUid(), e.getUid()) ) return false;
        return isSameIgnoringKey(e);
    }

    public boolean isSameIgnoringKey(MySalesOrderContact e)
    {
    ...
    public boolean isDifferent(MySalesOrderContact e)
    {
        return !isSame(e);
    }

    public boolean isDifferentIgnoringKey(MySalesOrderContact e)
    {
        return !isSameIgnoringKey(e);
    }
    ...
    public String toString()
    {
        ...
        out.append("MySalesOrderContact");
        out.append("(");
        out.append("Uid=");
        out.append(uid);
        out.append(")");
