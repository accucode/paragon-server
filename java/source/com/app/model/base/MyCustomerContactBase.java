...
public abstract class MyCustomerContactBase
    extends MyAbstractDaoDomain<MyCustomerContact>
    ...
    ,MyBasicTimestampsIF
{
    ...
    public static final MyCustomerContactFinder Finder = MyCustomerContactFinder.instance;
    ...
    public abstract Boolean getApprovalContact();
    ...
    public boolean hasApprovalContact(Boolean e)
    {
        return Kmu.isEqual(getApprovalContact(), e);
    }

    public boolean isApprovalContact()
    {
        if ( getApprovalContact() == null )
            return false;
        return getApprovalContact();
    }

    public boolean isApprovalContact(Boolean b)
    {
        return Kmu.isEqual(getApprovalContact(), b);
    }
    ...
    public abstract Boolean getBillingContact();
    ...
    public boolean hasBillingContact(Boolean e)
    {
    ...
    public boolean isBillingContact(Boolean b)
    {
        return Kmu.isEqual(getBillingContact(), b);
    }
    ...
    @Override
    protected final MyCustomerContactValidator getValidator()
    {
        return Validator;
    }

    @Override
    protected final MyCustomerContact asSubclass()
    {
        return (MyCustomerContact)this;
    }
     ...
     */
    public final MyCustomerContact getBasicCopy()
    {
        MyCustomerContact e;
     ...
     */
    public final void applyEditableFieldsTo(MyCustomerContact e)
    {
     ...
     * Associations and collections are NOT applied.
     */
    public final void applyEditableFieldsFrom(MyCustomerContact e)
    {
    ...
    {
        if ( !Kmu.isEqual(getApprovalContact(), e.getApprovalContact()) ) return false;
        if ( !Kmu.isEqual(getAuditLogTitle(), e.getAuditLogTitle()) ) return false;
        if ( !Kmu.isEqual(getBillingContact(), e.getBillingContact()) ) return false;
