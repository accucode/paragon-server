...
public class MyMetaSalesOrder_StatusCode
    ...
    implements KmMetaDaoPropertyIF<MySalesOrder,String>
{
    ...
    {
        return "A summary of the order's status.";
    }
    ...
    {
        return MySalesOrderValidator.instance.getStatusCodeValidator();
    }
    ...
    public ScDropdown newDropdown(String label)
    {
        ...
        e.addOptions(MySalesOrderStatus.values());
        return e;
    }
