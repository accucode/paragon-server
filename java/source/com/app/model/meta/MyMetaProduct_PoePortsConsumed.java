...
public class MyMetaProduct_PoePortsConsumed
    ...
    implements KmMetaDaoPropertyIF<MyProduct,Integer>
{
    ...
    {
        return "Poe Ports Consumed";
    }

    @Override
    public String getHelp()
    {
        return "The number of Power Over Ethernet ports that this uses in a network topology.";
    }
    ...
    {
        return MyProductValidator.instance.getPoePortsConsumedValidator();
    }
