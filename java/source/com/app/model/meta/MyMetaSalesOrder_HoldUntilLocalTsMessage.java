...
public class MyMetaSalesOrder_HoldUntilLocalTsMessage
    extends KmMetaStringProperty<MySalesOrder>
{
    ...
    {
        return "holdUntilLocalTsMessage";
    }
    ...
    {
        return model.getHoldUntilLocalTsMessage();
    }
    
    @Override
    public boolean hasValueFor(MySalesOrder model, String value)
    {
        return model.hasHoldUntilLocalTsMessage(value);
    }
