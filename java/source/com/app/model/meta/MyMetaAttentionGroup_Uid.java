...
public class MyMetaAttentionGroup_Uid
    ...
    implements KmMetaDaoPropertyIF<MyAttentionGroup,String>
{
    ...
    {
        return "The globally unique identifier.  This is a big ugly number and is usually not displayed.";
    }
    ...
    {
        return MyAttentionGroupValidator.instance.getUidValidator();
    }
