...
public class MyUserRecentProjectJunction
    ...
    implements MyUserRecentProjectDaoConstantsIF
{
    ...
    public MyUserRecentProjectJunction(KmhJunction context)
    {
        super(context);
    }
...
//    }
    ...
    {
        return new MyUserRecentProjectJunction(context().addAnd());
    }

    public MyUserRecentProjectJunction addOr()
    {
        return new MyUserRecentProjectJunction(context().addOr());
    }
