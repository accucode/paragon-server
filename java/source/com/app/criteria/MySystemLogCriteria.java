...
public class MySystemLogCriteria
    extends MyAbstractCriteria<MySystemLog>
    implements MySystemLogDaoConstantsIF
{
    ...
    public MySystemLogCriteria(KmCriteria parent)
    {
        super(parent);
    }

    public MySystemLogCriteria(KmCriteria parent, KmAbstractCriteria context)
    {
    ...
    public MySystemLogTraceCriteria joinToTraces()
    {
        return new MySystemLogTraceCriteria(joinTo(TRACES));
    }

    public MySystemLogTraceCriteria leftJoinToTraces()
    {
        return new MySystemLogTraceCriteria(leftJoinTo(TRACES));
    }
    ...
    {
        return new MySystemLogJunction(parent().addAnd());
    }

    public MySystemLogJunction addOr()
    {
        return new MySystemLogJunction(parent().addOr());
    }
    ...
    public MySystemLogCriteria createOn(KmModelJunction junction)
    {
        return new MySystemLogCriteria(parent(), junction.context());
    }
