    ...
    implements MyBlurbDaoConstantsIF
{
    ...
    public MyBlurbJunction(KmhJunction context)
    {
        super(context);
    }
...
//    }
    ...
    {
        return new MyBlurbJunction(context().addAnd());
    }

    public MyBlurbJunction addOr()
    {
        return new MyBlurbJunction(context().addOr());
    }
