...
public class MyMasterProductJunction
    ...
    implements MyMasterProductDaoConstantsIF
{
    ...
    public MyMasterProductJunction(KmhJunction context)
    {
        super(context);
    }
    ...
    {
        return new MyMasterProductJunction(context().addAnd());
    }

    public MyMasterProductJunction addOr()
    {
        return new MyMasterProductJunction(context().addOr());
    }
