...
public class MyAttentionGroupCriteria
    extends MyAbstractCriteria<MyAttentionGroup>
    implements MyAttentionGroupDaoConstantsIF
{
    ...
    public MyAttentionGroupCriteria(KmCriteria parent)
    {
        super(parent);
    }

    public MyAttentionGroupCriteria(KmCriteria parent, KmAbstractCriteria context)
    {
    ...
    public MyAttentionGroupJunction addAnd()
    {
        return new MyAttentionGroupJunction(parent().addAnd());
    }

    public MyAttentionGroupJunction addOr()
    {
        return new MyAttentionGroupJunction(parent().addOr());
    }
    ...
    @Override
    public MyAttentionGroupCriteria createOn(KmModelJunction junction)
    {
        return new MyAttentionGroupCriteria(parent(), junction.context());
    }
