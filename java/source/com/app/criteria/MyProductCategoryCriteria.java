...
public class MyProductCategoryCriteria
    extends MyAbstractCriteria<MyProductCategory>
    implements MyProductCategoryDaoConstantsIF
{
    ...
    public MyProductCategoryCriteria(KmhCriteria parent)
    {
        super(parent);
    }
    ...
    public MyProductCategoryJunction addAnd()
    {
        return new MyProductCategoryJunction(parent().addAnd());
    }

    public MyProductCategoryJunction addOr()
    {
        return new MyProductCategoryJunction(parent().addOr());
    }
}
