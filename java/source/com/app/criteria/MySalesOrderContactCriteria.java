...
public class MySalesOrderContactCriteria
    extends MyAbstractCriteria<MySalesOrderContact>
    implements MySalesOrderContactDaoConstantsIF
{
    ...
    public MySalesOrderContactCriteria(KmhCriteria parent)
    {
        super(parent);
    }
    ...
    {
        return new MySalesOrderContactJunction(parent().addAnd());
    }

    public MySalesOrderContactJunction addOr()
    {
        return new MySalesOrderContactJunction(parent().addOr());
    }
}
