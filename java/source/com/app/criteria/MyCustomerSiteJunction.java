...
public class MyCustomerSiteJunction
    ...
    implements MyCustomerSiteDaoConstantsIF
{
    ...
    public MyCustomerSiteJunction(KmhJunction context)
    {
        super(context);
    }
    ...
    {
        return new MyCustomerSiteJunction(context().addAnd());
    }

    public MyCustomerSiteJunction addOr()
    {
        return new MyCustomerSiteJunction(context().addOr());
    }
