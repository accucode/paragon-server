...
public class MyHolidayJunction
    ...
    implements MyHolidayDaoConstantsIF
{
    ...
    public MyHolidayJunction(KmhJunction context)
    {
        super(context);
    }
...
//    }
    ...
    {
        return new MyHolidayJunction(context().addAnd());
    }

    public MyHolidayJunction addOr()
    {
        return new MyHolidayJunction(context().addOr());
    }
