    ...
    implements MyCustomerContactDaoConstantsIF
{
    ...
    public void whereUidIs(MyCustomerContact e)
    {
        whereUid().is(e.getUid());
    }

    public void whereUidIsNot(MyCustomerContact e)
    {
    ...
    public MyCustomerContactJunction all()
    {
        return addAnd();
    }

    public MyCustomerContactJunction any()
    {
        return addOr();
    }

    public MyCustomerContactJunction none()
    {
        return addNotOr();
    }
    ...
    public MyCustomerContactJunction addNotAnd()
    {
        return new MyCustomerContactJunction(parent().addNotAnd());
    }

    public MyCustomerContactJunction addNotOr()
    {
        return new MyCustomerContactJunction(parent().addNotOr());
    }
