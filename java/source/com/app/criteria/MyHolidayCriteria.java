...
public class MyHolidayCriteria
    extends MyAbstractCriteria<MyHoliday>
    implements MyHolidayDaoConstantsIF
{
    ...
    public MyHolidayCriteria(KmhCriteria parent)
    {
        super(parent);
    }
    ...
    public void whereUidIs(MyHoliday e)
    {
        whereUid().is(e.getUid());
    }

    public void whereUidIsNot(MyHoliday e)
    {
    ...
    public KmhDateCondition whereDay()
    {
        return new KmhDateCondition(context(), alias(), DAY);
    }
    ...
    {
        parent().sortAscending(DAY);
    }

    public void sortOnDayDescending()
    {
        parent().sortDescending(DAY);
    }

    public void sortOnDay(boolean asc)
    {
        if ( asc )
            sortOnDay();
        else
    ...
    public void selectDistinctDay()
    {
        selectDistinct(DAY);
    }

    public void selectCountDistinctDay()
    {
        selectCountDistinct(DAY);
    }

    public void selectMinimumDay()
    {
        selectMinimum(DAY);
    }

    public void selectMaximumDay()
    {
        selectMaximum(DAY);
    }

    public void selectAverageDay()
    {
        selectAverage(DAY);
    }

    public void selectSumDay()
    {
        selectSum(DAY);
    }
    ...
    public MyHolidayJunction all()
    {
        return addAnd();
    }

    public MyHolidayJunction any()
    {
        return addOr();
    }

    public MyHolidayJunction none()
    {
        return addNotOr();
    }
    ...
    public MyHolidayJunction addNotAnd()
    {
        return new MyHolidayJunction(parent().addNotAnd());
    }

    public MyHolidayJunction addNotOr()
    {
        return new MyHolidayJunction(parent().addNotOr());
    }

    public MyHolidayJunction addAnd()
    {
        return new MyHolidayJunction(parent().addAnd());
    }

    public MyHolidayJunction addOr()
    {
        return new MyHolidayJunction(parent().addOr());
    }
}
