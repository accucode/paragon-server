...
public class MyEndUserCriteria
    extends MyAbstractCriteria<MyEndUser>
    implements MyEndUserDaoConstantsIF
{
    ...
    public MyEndUserCriteria(KmhCriteria parent)
    {
        super(parent);
    }
    ...
    public MyEndUserSiteCriteria joinToSites()
    {
        return new MyEndUserSiteCriteria(joinTo(SITES));
    }

    public MyEndUserSiteCriteria leftJoinToSites()
    {
        return new MyEndUserSiteCriteria(leftJoinTo(SITES));
    }
    ...
    public MyEndUserJunction addAnd()
    {
        return new MyEndUserJunction(parent().addAnd());
    }

    public MyEndUserJunction addOr()
    {
        return new MyEndUserJunction(parent().addOr());
    }
}
