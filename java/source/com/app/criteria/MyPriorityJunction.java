...
public class MyPriorityJunction
    ...
    implements MyPriorityDaoConstantsIF
{
    ...
    public MyPriorityJunction(KmhJunction context)
    {
        super(context);
    }
...
//    }
    ...
    {
        return new MyPriorityJunction(context().addAnd());
    }

    public MyPriorityJunction addOr()
    {
        return new MyPriorityJunction(context().addOr());
    }
