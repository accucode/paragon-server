...
public class MySiteContactCriteria
    extends MyAbstractCriteria<MySiteContact>
    implements MySiteContactDaoConstantsIF
{
    ...
    public MySiteContactCriteria(KmhCriteria parent)
    {
        super(parent);
    }
    ...
    public void whereUidIs(MySiteContact e)
    {
        whereUid().is(e.getUid());
    }

    public void whereUidIsNot(MySiteContact e)
    {
    ...
    public MySiteContactJunction all()
    {
        return addAnd();
    }

    public MySiteContactJunction any()
    {
        return addOr();
    }

    public MySiteContactJunction none()
    {
        return addNotOr();
    }
    ...
    public MySiteContactJunction addNotAnd()
    {
        return new MySiteContactJunction(parent().addNotAnd());
    }

    public MySiteContactJunction addNotOr()
    {
        return new MySiteContactJunction(parent().addNotOr());
    }

    public MySiteContactJunction addAnd()
    {
        return new MySiteContactJunction(parent().addAnd());
    }

    public MySiteContactJunction addOr()
    {
        return new MySiteContactJunction(parent().addOr());
    }
}
