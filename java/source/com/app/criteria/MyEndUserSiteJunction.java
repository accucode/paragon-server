...
public class MyEndUserSiteJunction
    ...
    implements MyEndUserSiteDaoConstantsIF
{
    ...
    public MyEndUserSiteJunction(KmhJunction context)
    {
        super(context);
    }
    ...
    {
        return new MyEndUserSiteJunction(context().addAnd());
    }

    public MyEndUserSiteJunction addOr()
    {
        return new MyEndUserSiteJunction(context().addOr());
    }
