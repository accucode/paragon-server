...
public class MyOrderNumberCriteria
    extends MyAbstractCriteria<MyOrderNumber>
    implements MyOrderNumberDaoConstantsIF
{
    ...
    public MyOrderNumberCriteria(KmhCriteria parent)
    {
        super(parent);
    }
    ...
    {
        return new MyOrderNumberJunction(parent().addAnd());
    }

    public MyOrderNumberJunction addOr()
    {
        return new MyOrderNumberJunction(parent().addOr());
    }
}
