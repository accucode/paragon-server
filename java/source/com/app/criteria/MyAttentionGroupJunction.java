...
public class MyAttentionGroupJunction
    ...
    implements MyAttentionGroupDaoConstantsIF
{
    ...
    public MyAttentionGroupJunction(KmJunction context)
    {
        super(context);
    }

    public MyAttentionGroupJunction(KmJunction context, KmAbstractCriteria parent)
    {
    ...
    {
        return new MyAttentionGroupJunction(context().addAnd(), parent());
    }

    public MyAttentionGroupJunction addOr()
    {
        return new MyAttentionGroupJunction(context().addOr(), parent());
    }
