...
public class MyCustomerTierCriteria
    extends MyAbstractCriteria<MyCustomerTier>
    implements MyCustomerTierDaoConstantsIF
{
    ...
    public MyCustomerTierCriteria(KmhCriteria parent)
    {
        super(parent);
    }
    ...
    {
        return new MyCustomerTierJunction(parent().addAnd());
    }

    public MyCustomerTierJunction addOr()
    {
        return new MyCustomerTierJunction(parent().addOr());
    }
}
