...
public class MyEndUserSiteCriteria
    extends MyAbstractCriteria<MyEndUserSite>
    implements MyEndUserSiteDaoConstantsIF
{
    ...
    public MyEndUserSiteCriteria(KmhCriteria parent)
    {
        super(parent);
    }
    ...
    public void selectEndUserUid()
    {
        select(END_USER_UID);
    }

    public void selectMinimumEndUserUid()
    {
        selectMinimum(END_USER_UID);
    }

    public void selectMaximumEndUserUid()
    {
        selectMaximum(END_USER_UID);
    }

    public void groupByEndUserUid()
    {
        groupBy(END_USER);
    }

    public MyEndUserCriteria joinToEndUser()
    {
        return new MyEndUserCriteria(joinTo(END_USER));
    }

    public MyEndUserCriteria leftJoinToEndUser()
    {
        return new MyEndUserCriteria(leftJoinTo(END_USER));
    }

    public KmhStringCondition whereEndUserUid()
    {
        return new KmhStringCondition(parent(), fullName(END_USER_UID));
    }

    public void whereEndUserIs(MyEndUser e)
    {
        if ( e == null )
            whereEndUserUid().isNull();
        else
            whereEndUserUid().is(e.getUid());
    }
    ...
    public MyEndUserSiteJunction addAnd()
    {
        return new MyEndUserSiteJunction(parent().addAnd());
    }

    public MyEndUserSiteJunction addOr()
    {
        return new MyEndUserSiteJunction(parent().addOr());
    }
}
