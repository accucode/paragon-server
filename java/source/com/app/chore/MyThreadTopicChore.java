 ...
 * subclasses must break any long running tasks into a series of multiple
 ...
 *
 * If a single transaction takes too long, then another JVM may think that
 * the current owner died and attempt to take over. See MyThreadTopic for
 * the pertinent constants.
 *
 * @see MyThreadTopic
 */
public abstract class MyThreadTopicChore
    extends MyChore
{
    //##################################################
    //# run
