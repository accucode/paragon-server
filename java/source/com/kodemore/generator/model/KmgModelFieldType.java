...
public class KmgModelFieldType
    extends KmgElement
{
    //##################################################
    //# variables
    ...
    public KmgModelFieldType(KmgElement parent)
    {
        super(parent);
    ...
    {
        if ( !hasFixedLength() )
            throw newError("Field (%s) does not have a fixed length.", this);
    ...
    public void parse(KmStfElement x)
    {
        ...
        if ( _protoType == null )
            throw newError(x, "Unknown baseType: %s", baseTypeName);
    ...
    public static KmComparator<KmgModelFieldType> getNameComparator()
    {
        return new KmComparator<KmgModelFieldType>()
        {
            @Override
            public int compare(KmgModelFieldType a, KmgModelFieldType b)
            {
