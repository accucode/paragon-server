...
public class KmMemoryPrintTool
{
    ...
    {
        System.out.println("Max:   The maximum amount of memory that the virtual machine will attempt to use.");
        System.out.println("Total: the total amount of memory currently available for current and future objects.");
        System.out.println("Free:  An approximation to the total amount of memory currently available for future allocated objects.");
