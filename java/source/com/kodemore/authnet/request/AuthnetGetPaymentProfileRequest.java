...
public class AuthnetGetPaymentProfileRequest
    extends AuthnetAbstractRequest
{
    ...
    public AuthnetGetPaymentProfileRequest()
    {
        super();
    }
    ...
    @Override
    public AuthnetGetPaymentProfileResponse post()
    {
        return post(new AuthnetGetPaymentProfileResponse());
    }
