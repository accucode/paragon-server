...
public class AuthnetCreatePaymentProfileRequest
    extends AuthnetAbstractRequest
{
    ...
    public AuthnetCreatePaymentProfileRequest()
    {
    ...
    @Override
    public AuthnetCreatePaymentProfileResponse post()
    {
        return post(new AuthnetCreatePaymentProfileResponse());
    }
