...
public class KmAuthnetDeletePaymentProfileRequest
    extends KmAuthnetAbstractRequest
{
    ...
    public KmAuthnetDeletePaymentProfileRequest()
    {
        super();
    }
    ...
    @Override
    public KmAuthnetDeletePaymentProfileResponse post()
    {
        return post(new KmAuthnetDeletePaymentProfileResponse());
    }
