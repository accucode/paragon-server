...
import com.kodemore.authnet.request.KmAuthnetAbstractRequest;
import com.kodemore.authnet.request.KmAuthnetAbstractResponse;
import com.kodemore.log.KmLog;
import com.kodemore.utility.Kmu;
import com.kodemore.xml.utility.KmXmlBuilder;
import com.kodemore.xml.utility.KmXmlWrapper;

public class KmAuthnetPost
{
    //##################################################
    //# variables
    //##################################################
    ...
    public KmAuthnetAbstractRequest getRequest()
    {
        return _request;
    }

    public void setRequest(KmAuthnetAbstractRequest e)
    {
        _request = e;
    }

    public KmAuthnetAbstractResponse getResponse()
    {
        return _response;
    }

    public void setResponse(KmAuthnetAbstractResponse e)
    {
        _response = e;
    }
    ...
    public void post()
    {
        ...
        catch ( KmAuthnetRetryableError ex )
        {
            logRetryable(ex);
            throw ex;
        }
    ...
    private void logRetryable(KmAuthnetRetryableError ex)
    {
        if ( ex.isLogWarn() )
        {
    ...
    private void createUrl() throws MalformedURLException
    {
        ...
        String domain = KmAuthnetConfiguration.getDomain();
        String url = KmAuthnetConfiguration.getUrl();
